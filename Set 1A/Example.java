    ...
    public static void main (String[]args){
        ...
        switch(choice) {
            ...
            case 5:
                ...
                //Gemetric series calc
                double geosum = firstgterm_*(1 - Math.pow(commonratio_, ngterms_))/(1 - commonratio_);
                
                System.out.println("Sum of gemetric series with " + ngterms_ + " terms, the first of which being " + firstgterm_ + " and the common ratio being " + commonratio_ + " is " + geosum);
        }
    }
}